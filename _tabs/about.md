...
<div class="d-flex gap-3 flex-wrap mt-3 mb-3">
  <div class="p-3 rounded" style="background:var(--card-bg);border:1px solid var(--border-color);flex:1;min-width:250px;">
    <strong>👨‍💻 Ingeniero Agrónomo & Desarrollador</strong><br>
    <small>🎓 Universidad de Caldas</small>
    <div class="mt-2">
      <a href="https://linkedin.com/in/lucas-mateo-tabares-franco-31797aa2">💼 LinkedIn</a>
      · <a href="https://github.com/iglm">🐙 GitHub</a>
      · <a href="mailto:mateotabares7@gmail.com">✉️ Email</a>
    </div>
  </div>
</div>
